function Assignment_graphs_finished(n, abc)
    clc;

    % Matrix sizes to test
    % matrix_sizes = 100:100:20000;

    % Matrix sizes to test
    matrix_sizes = [5, 10, 50, 100, 200, 500, 1000, 5000, 10000, 20000];
    ...
    plot(matrix_sizes, jacobi_times, 'LineWidth', 1.5, 'DisplayName', 'Jacobi Method');
    % Plot added to current figure
    hold on;
    % Plot computation time vs matrix sizes GS
    plot(matrix_sizes, gauss_seidel_times, 'LineWidth', 1.5, 'DisplayName', 'Gauss-Seidel Method');
    % X axis label
    ...
    plot(matrix_sizes, jacobi_setup_times, 'LineWidth', 1.5, 'DisplayName', 'Jacobi Method');
    % Plot added to current figure
    hold on;
    % Plot setup time vs matrix sizes GS
    plot(matrix_sizes, gauss_seidel_setup_times, 'LineWidth', 1.5, 'DisplayName', 'Gauss-Seidel Method');
    % X axis label
    xlabel('Matrix Size (n)');
    % Y axis label
    ...
    plot(matrix_sizes, jacobi_total_times, 'LineWidth', 1.5, 'DisplayName', 'Jacobi Method');
    % Plot added to current figure
    hold on;
    % Plot total time vs matrix sizes jacobi
    plot(matrix_sizes, gauss_seidel_total_times, 'LineWidth', 1.5, 'DisplayName', 'Gauss-Seidel Method');
    % X axis label
    xlabel('Matrix Size (n)');
    % Y axis label
...
% Jacobi iteration with the output being x and iterations
...
% Gauss-Seidel iteration with the output being x and iterations
